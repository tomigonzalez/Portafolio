...
const LayoutSecundario: React.FC = () => {
  return (
    <div className="h-5/6 animate-fade xl:w-2/4 lg:w-4/6 md:w-9/12 sm:w-9/12 w-11/12 flex flex-col items-center  justify-evenly rounded-3xl bg-secondary  text-white ">
